...
Migrating ArgoCD to a new namespace is difficult once installed, making the chosen value semi-permanent.
...
Applying the two manifests below hands control of the cluster over to ArgoCD. 
